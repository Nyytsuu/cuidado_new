...
function isClinicOpenNow(clinic: Clinic, now: Date = new Date()): boolean {
  // A deactivated or unapproved clinic is never considered open
...
export default function FindClinic() {
  ...
  return (
    <div className={`findclinic-page ${sidebarExpanded ? "sidebar-expanded" : ""}`}>
      ...
      {showBookingModal && selectedClinic && createPortal(
              ...
              <section className="fc-profile-hero">
                ...
                <div className="fc-profile-summary">
                  {(() => {
                    ...
                    const pillLabel = !isActive
                      ...
                      : "Closed";
                    return (
                      <span className={`fc-status-pill ${pillClass}`}>
                        {pillLabel}
                      </span>
                    );
                  })()}
                ...
                {(() => {
                  const isActive =
                    profileClinic.status === "approved" &&
                    profileClinic.account_status === "active";
                  const canBook = isActive && profileClinic.isOpenNow;
                  ...
                  return (
                    <button
                      type="button"
                      className={`fc-modal-btn fc-profile-book-btn ${
                        canBook ? "primary" : "secondary"
                      }`}
                      disabled={!canBook}
                      onClick={() => {
                      ...
                      <span>
                        ...
                        <strong>
                          {profileClinic.opening_time && profileClinic.closing_time
                            ? `${formatClockTime(profileClinic.opening_time)} - ${formatClockTime(profileClinic.closing_time)}`
                            : "Hours not provided"}
                        </strong>
                      </span>
                    </div>
