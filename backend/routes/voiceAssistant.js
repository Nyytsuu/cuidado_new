...
const FILIPINO_SYMPTOM_ALIASES = [
  ...
  { aliases: ["sakit tiyan", "sakit ng tiyan", "masakit ang tiyan", "pananakit ng tiyan"], symptoms: ["stomach pain", "abdominal pain"] },
  { aliases: ["pagtatae", "nagtatae"], symptoms: ["diarrhea"] },
  { aliases: ["hirap huminga", "hirap sa paghinga", "nahihirapan huminga", "kinakapos ng hininga"], symptoms: ["shortness of breath", "difficulty breathing"] },
  { aliases: ["sakit dibdib", "sakit ng dibdib", "masakit ang dibdib", "pananakit ng dibdib"], symptoms: ["chest pain"] },
  ...
  { aliases: ["sakit lalamunan", "sakit ng lalamunan", "masakit ang lalamunan", "namamagang lalamunan"], symptoms: ["sore throat"] },
